...
public class IRecyclerViewFragment extends Fragment implements com.example.myapplication.view.IRecyclerViewFragment, OnNoteClickListener {

    private NoteAdapter adapter;

    public IRecyclerViewFragment() {
